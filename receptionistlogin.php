...
$query_Recordset1 = "SELECT * FROM receptionist";
...
if (isset($_POST['userName'])) {
  ...
  $MM_redirectLoginSuccess = "receptionistloginsuccess.php";
  $MM_redirectLoginFailed = "receptionistlogin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_hmsphp, $hmsphp);
  
  $LoginRS__query=sprintf("SELECT Name, Phone FROM receptionist WHERE Name=%s AND Phone=%s",
