...
table {
  ...
  <table>
    ...
    <tr>
      ...
      <td><?php echo $row_Recordset1['Specialization']; ?></td>
      <td><?php echo $row_Recordset1['Phone']; ?></td>
      <td><?php echo $row_Recordset1['Age']; ?></td>
      <td><?php echo $row_Recordset1['Designation']; ?></td>
      <td><a href="removedoc.php?Name=<?php echo $row_Recordset1['Name']; ?>">Delete</a></td>
    </tr>
