...
$query_Patientlogin = "SELECT name, mobile FROM patients";
$Patientlogin = mysql_query($query_Patientlogin, $hmsphp) or die(mysql_error());
$row_Patientlogin = mysql_fetch_assoc($Patientlogin);
$totalRows_Patientlogin = mysql_num_rows($Patientlogin);
...
if (isset($_POST['userName'])) {
  ...
  $MM_redirectLoginSuccess = "patientloginsuccess.php";
  $MM_redirectLoginFailed = "Patientlogin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_hmsphp, $hmsphp);
  
  $LoginRS__query=sprintf("SELECT name, mobile FROM patients WHERE name=%s AND mobile=%s",
...
<?php
mysql_free_result($Patientlogin);
?>
