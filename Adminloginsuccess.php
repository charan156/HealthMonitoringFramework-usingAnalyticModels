...
<html>
		...
		<div class="content">
			...
			<div class="contact">
				<div class="project-top-patination">
								<ul>
									<li><a href="doctorpatientlogin.php">Logout</a></li>
  ...
  <input name="addnewpatient" value="PATIENT REGISTRATION" type="submit"></form>
<br>
<br>
<form method="post" action="doctorinfo.php" name="prescription">
  <input name="prescription" value="DOCTORS' INFORMATION" type="submit"></form>
<br>
<br>
