...
$query_Recordset1 = "SELECT Name, Phone FROM doctors";
...
if (isset($_POST['userName'])) {
  ...
  $MM_redirectLoginSuccess = "doctorloginhome.php";
  $MM_redirectLoginFailed = "doctorlogin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_hmsphp, $hmsphp);
  
  $LoginRS__query=sprintf("SELECT Name, Phone FROM doctors WHERE Name=%s AND Phone=%s",
