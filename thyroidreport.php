...
mysql_select_db($database_hmsphp, $hmsphp);
$query_Recordset1 = sprintf("SELECT PatientName, DoctorName, TSH, FT4, FT3, Final FROM thyroiddata WHERE DoctorName = %s", GetSQLValueString($colname_Recordset1, "text"));
  ...
  <table>
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo $row_Recordset1['TSH']; ?></td>
        <td><?php echo $row_Recordset1['FT4']; ?></td>
        <td><?php echo $row_Recordset1['FT3']; ?></td>
